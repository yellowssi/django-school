    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tel', models.CharField(max_length=8, verbose_name='联系电话')),
            ],
            options={
                'verbose_name': '学院',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='jwc.Student', verbose_name='学生')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='teacher',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='jwc.User', verbose_name='用户'),
        ),
        migrations.AddField(
            model_name='student',
            name='user',
